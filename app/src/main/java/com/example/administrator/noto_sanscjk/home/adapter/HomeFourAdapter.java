...
public class HomeFourAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    private Context context;
    private List<Index.DataBean.ListFourBean> list;

    public HomeFourAdapter(Context context, List<Index.DataBean.ListFourBean> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        FourViewHolder holder=new FourViewHolder(inflate);
