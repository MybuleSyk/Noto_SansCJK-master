...
public class HomeSixAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    private List<Index.DataBean.ListSixBean> list;

    public HomeSixAdapter(Context context, List<Index.DataBean.ListSixBean> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        SixViewHolder holder=new SixViewHolder(inflate);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        SixViewHolder holder1= (SixViewHolder) holder;
