...
public class HomeThreeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    private List<Index.DataBean.ListThreeBean> list;

    public HomeThreeAdapter(Context context, List<Index.DataBean.ListThreeBean> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
       ...
       ThreeViewHolder holder=new ThreeViewHolder(inflate);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ThreeViewHolder holder1= (ThreeViewHolder) holder;
