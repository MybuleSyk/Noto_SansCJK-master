...
public class YuyinActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initView() {
        ...
        SpeechUtility.createUtility(getApplicationContext(), SpeechConstant.APPID +"=5aefa817");
        ...
        mIat = SpeechRecognizer.createRecognizer(YuyinActivity.this, mInitListener);

        // 初始化听写Dialog，如果只使用有UI听写功能，无需创建SpeechRecognizer
        // 使用UI听写功能，请根据sdk文件目录下的notice.txt,放置布局文件和图片资源
        mIatDialog = new RecognizerDialog(YuyinActivity.this, mInitListener);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.iat_recognize:
                // 移动数据分析，收集开始听写事件
                FlowerCollector.onEvent(YuyinActivity.this, "iat_recognize");
